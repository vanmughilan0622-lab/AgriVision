      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="absolute top-full left-0 md:left-full md:-top-2 md:ml-4 mt-2 w-80 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl z-50 overflow-hidden"
          >
