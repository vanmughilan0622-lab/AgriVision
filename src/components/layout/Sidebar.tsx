...
export function Sidebar() {
    ...
    return (
        <>
            {/* Mobile Header */}
            <div className="md:hidden fixed top-0 left-0 right-0 h-[calc(4rem+env(safe-area-inset-top))] pt-[env(safe-area-inset-top)] bg-white/80 dark:bg-slate-950/80 backdrop-blur-2xl border-b border-slate-200 dark:border-white/10 z-50 flex items-center px-4 justify-between">
            ...
            <motion.aside
                ...
                className={cn(
                    "hidden md:flex flex-col h-[100dvh] pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] border-r border-white/10 bg-slate-950/40 backdrop-blur-2xl text-white sticky top-0 z-40",
                    !isOpen && "items-center"
                )}
            >
                {/* Header */}
            ...
            <AnimatePresence>
                {isOpen && (
                    <>
                        ...
                        >
                            <div className="p-6 pt-[calc(1.5rem+env(safe-area-inset-top))] flex items-center gap-4 border-b border-white/10 shrink-0">
